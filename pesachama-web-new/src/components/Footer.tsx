                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
                    ...
                    <div className="space-y-6">
                        <Link to="/" className="flex items-center space-x-3 group">
                             <RatibuLogo className="h-24 md:h-28 w-auto text-slate-900 dark:text-white drop-shadow-[0_14px_40px_rgba(0,200,83,0.16)] group-hover:scale-[1.05] transition-transform" />
                        </Link>
